...
router.post('/create', authCheck.ensureAuthenticated, (req, res) => {
...
router.get('/all', authCheck.ensureAuthenticated ,(req, res) => {
...
router.get('/details/:id', authCheck.ensureAuthenticated, (req, res) => {
...
router.get('/user', authCheck.ensureAuthenticated, (req, res) => {
...
router.delete('/delete/:id', authCheck.ensureAuthenticated, (req, res) => {
  const id = req.params.id
  const user = req.user._id
...
router.put('/edit/:id', authCheck.ensureAuthenticated, (req, res) => {
  const id = req.params.id;
  const furniture = req.body;
...
router.get('/:id', authCheck.ensureAuthenticated, (req, res) => {
  const id = req.params.id
